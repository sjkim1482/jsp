...
public class BasicServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// new Date 부분을 db 에서 조회한 데이터라고 생각하보면
		// 사용자 별로 요청에 대한 응답을 각각 다르게 생성하는 것이 가능하다.
		// db에 대한 연동 부분은 html, javascript만 이용해서는 불가능 ==> 정적
		// servlet을 동해 응답으로 생성하는 html을 동적으로 변경 ==> 동적(servlet/jsp를 배우는 이유)
		// servlet의 라이프 사이클
		...
		// 단 web.xml의 servlet 엘레먼트의 하위 엘레먼트인 load-on-startup 엘레멘트 값으로
		...
		//											*.jsp, *.jspx url-pattern에 따라 jsp라는 이름의 서블릿에서 처리(JspSetvlet)
